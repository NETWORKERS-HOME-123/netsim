...
export const multiDeviceLabs: MultiDeviceLab[] = [
  ...
  // ===== SCENARIO 2: HSRP + Inter-VLAN Routing + EtherChannel =====
  {
    ...
    topology: {
      nodes: [
        {
          id: "R1", type: "router", label: "R1 (Core)", x: 300, y: 30,
          interfaces: [
        ...
        {
          id: "DSW1", type: "switch", label: "DSW1 (Active)", x: 160, y: 120,
          interfaces: [
        ...
        {
          id: "DSW2", type: "switch", label: "DSW2 (Standby)", x: 440, y: 120,
          interfaces: [
        ...
        {
          id: "ASW1", type: "switch", label: "ASW1", x: 160, y: 260,
          interfaces: [
        ...
        {
          id: "ASW2", type: "switch", label: "ASW2", x: 440, y: 260,
          interfaces: [
            { name: "Gi0/1", ip: "N/A", mask: "N/A", connectsTo: "DSW1" },
            { name: "Gi0/2", ip: "N/A", mask: "N/A", connectsTo: "DSW2" },
            { name: "Fa0/1", ip: "N/A", mask: "N/A" },
        ...
        {
          id: "PC1", type: "pc", label: "PC1 (VLAN10)", x: 80, y: 340,
          interfaces: [{ name: "eth0", ip: "192.168.10.100", mask: "255.255.255.0" }],
        },
        {
          id: "PC2", type: "pc", label: "PC2 (VLAN20)", x: 240, y: 340,
          interfaces: [{ name: "eth0", ip: "192.168.20.100", mask: "255.255.255.0" }],
        },
        {
          id: "PC3", type: "pc", label: "PC3 (VLAN30)", x: 520, y: 340,
